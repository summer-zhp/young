...
Page({
  ...
  goToCaptionImage() {
    wx.navigateTo({
      url: '/packageB/pages/caption-image/caption-image'
    })
  },
  ...
  goToQRCode() {
    wx.navigateTo({
      url: '/packageB/pages/qrcode-generator/qrcode-generator'
    })
  },
  ...
  goToImage2Pdf() {
    wx.navigateTo({
      url: '/packageB/pages/image2pdf/image2pdf'
    })
  },
  ...
  goToImageCompressor() {
    wx.navigateTo({
      url: '/packageB/pages/image-compressor/image-compressor'
    })
  },
  ...
  goToDecision() {
    wx.navigateTo({
      url: '/packageA/pages/decision/decision'
    })
  },
  ...
  goToSignature() {
    wx.navigateTo({
      url: '/packageB/pages/signature/signature'
    })
  },
  ...
  goToVault() {
    wx.navigateTo({
      url: '/packageB/pages/vault/vault'
    })
  },
